...
public class ParserJsonWithJacksonTest {
    ParserJsonWithJackson parserJsonWithJackson;

    @Before
    public void set() {
        parserJsonWithJackson=new ParserJsonWithJackson();
    }
    ...
    public void test() {
        ...
        assertEquals(stringMap, parserJsonWithJackson.parserJson(json));
    }
}
